...
export function ViewSlide({ pdfUrl, slideNumber, totalSlides }: ViewSlideProps) {
  ...
  const slideWidth = typeof window !== "undefined" ? Math.min(window.innerWidth * 0.5, 880) : 800
  ...
  return (
    ...
    >
      <Document
        ...
        loading={
          <div className="flex flex-col items-center justify-center gap-4 animate-pulse bg-zinc-100 rounded-lg" style={{ width: slideWidth, height: slideHeight }}>
