...
export function FeatureSection({
  ...
  return (
    <section className={cn(darker ? "bg-[#F3F4F6]" : "bg-[#F9FAFB]")}>
      <div className="mx-auto max-w-[1400px] px-4 py-16 sm:py-20 sm:px-6 lg:px-8 lg:py-28">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          ...
          <div className={cn("lg:order-2", visualRight && "lg:order-1")}>
            ...
            <p className="mt-5 max-w-[52ch] text-pretty text-base leading-relaxed text-[#71717A] sm:text-lg">
              {body}
            </p>
          </div>
        </div>
