      ...
      <div className="flex flex-col gap-2.5">
        {CATEGORIES.map((cat) => {
          ...
          const icons: Record<string, string> = {
            bug_report: "M10.29 3.86l-8.1 14c-.6 1.04.15 2.14 1.21 2.14h17.2c1.06 0 1.81-1.1 1.21-2.14l-8.1-14c-.6-1.04-1.82-1.04-2.42 0zM12 8v5M12 17m-1.5 0a1.5 1.5 0 1 0 3 0 1.5 1.5 0 1 0-3 0",
