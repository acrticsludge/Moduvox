      ...
      <div className="w-full max-w-sm rounded-xl border border-zinc-200 bg-white p-8 shadow-lg">
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-lg bg-[#18181B] px-4 py-2.5 text-sm font-medium text-white transition-all hover:bg-[#27272A] active:scale-[0.98] disabled:opacity-50"
          >
        ...
        <p className="mt-6 text-center text-sm text-[#71717A]">
          ...
          <Link href="/signup" className="font-medium text-[#18181B] hover:underline">
            Sign up
          </Link>
        </p>
      </div>
